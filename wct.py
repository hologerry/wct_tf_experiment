...
from utils import center_crop_to, swap_filter_fit
...
class WCT(object):
    ...
    def __init__(self, checkpoints, relu_targets, vgg_path, device='/gpu:0',
        ...
        with graph.device(device):
            ...
            for relu_target, checkpoint_dir in zip(relu_targets, checkpoints):
                ...
                relu_vars = [v for v in tf.trainable_variables()
                ...
                if ckpt and ckpt.model_checkpoint_path:
                    ...
                    raise Exception('No checkpoint found for target {} in dir {}'.format(
    ...
    def predict(self, content, style, alpha=1, swap5=False, ss_alpha=1, adain=False):
        ...
        if swap5 is True and self.ss_stride != 1:
            ...
            should_refit, H, W = swap_filter_fit(
                old_H, old_W, self.ss_patch_size, self.ss_stride)
