...
from utils import (center_crop, get_files, get_img, preserve_colors_np, resize_to, save_img)
from wct import WCT
...
parser.add_argument('--style-size', type=int,
                    help="Resize style image to this size before cropping, default 512", default=0)
