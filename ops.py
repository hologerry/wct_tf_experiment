...
def style_swap(content, style, patch_size, stride):
    ...
    ss_enc = tf.nn.conv2d(content, style_patches_norm, [1, stride, stride, 1], 'VALID')
    ...
    ss_dec = tf.nn.conv2d_transpose(ss_oh, style_patches, deconv_out_shape, [1, stride, stride, 1], 'VALID')
    ...
    counting = tf.nn.conv2d_transpose(ss_oh_sum, filter_ones, deconv_out_shape, [1, stride, stride, 1], 'VALID')
